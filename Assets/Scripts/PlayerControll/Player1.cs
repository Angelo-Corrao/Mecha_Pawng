        ...
        if (collision.gameObject.CompareTag("Ball"))
        {
            ...
            if (puurfectShoot && x > 0)
            {
                ...
                if (time < animationTime * dashPositiveTime)
                {
                    ...
                    {
                        sound[3].Play(); //PURFECTSHOT COLPITO BENE
    ...
    void Update() {
            ...
            if (Input.GetKeyDown(KeyCode.Space)) {
                switch (activeAbility) {
                    case Abilities.MAGNET_PAW:
                        ...
                        abilityTextP1.text = string.Empty;
                        break;
        ...
        if (puurfectShoot) {
            ...
            if (time < animationTime * dashPositiveTime) {
                ...
                transform.position += Vector3.left * ((dashSpeed * dashPositiveTime) / (1 - dashPositiveTime)) * Time.deltaTime;
